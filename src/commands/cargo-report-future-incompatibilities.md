...
cargo-report-future-incompatibilities --- 报告未来将停止编译的 crate
...
显示之前构建过程中产生的“未来不兼容”警告报告。
这类警告对应的变更在未来可能升级为硬错误，
从而导致依赖在未来 rustc 版本中无法继续构建。

更多内容请参见[未来不兼容报告](../reference/future-incompat-report.html)章节。
...
<dd class="option-desc"><p>显示指定 Cargo 生成 id 的报告。
若未指定，则显示最新报告。</p>
</dd>
...
<dd class="option-desc"><p>要显示报告的 package。
...
1. 显示最新 future-incompat 报告：

       cargo report future-incompat

2. 显示指定 package 的最新 future-incompat 报告：
